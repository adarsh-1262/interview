...
const CirclesSection = () => {
  return (
    <section className="relative w-full h-auto bg-white py-12">
      {/* First Row */}
      <div className="absolute top-8 sm:top-[35px] left-[5%] sm:left-[3%]">
        <div
      ...
      <div className="absolute top-8 sm:top-[35px] left-[30%] sm:left-[32.5%]">
      ...
      <div className="absolute top-8 sm:top-[35px] left-[45%] sm:left-[45%]">
        <div
          className="relative w-[140px] sm:w-[180px] h-[140px] sm:h-[180px] rounded-full overflow-hidden shadow-lg border-4 border-none"
          style={{
            background:
      ...
      <div className="absolute top-8 sm:top-[35px] left-[62.7%] sm:left-[57.7%]">
      ...
      <div className="absolute top-8 sm:top-[35px] right-[10%] sm:right-[5%]">
        <div
          className="relative w-[140px] sm:w-[180px] h-[140px] sm:h-[180px] rounded-full overflow-hidden shadow-lg border-4 border-none"
          style={{
      ...
      {/* Second Row */}
      <div className="absolute top-[190px] sm:top-[190px] left-[10%] sm:left-[17%]">
        <div className="relative w-[140px] sm:w-[180px] h-[140px] sm:h-[180px] rounded-full overflow-hidden shadow-lg border-4 border-none">
          <img src={image3} className="w-full h-full object-cover" />
        </div>
      </div>

      <div className="absolute top-[215px] sm:top-[215px] right-[10%] sm:right-[5%]">
        <div
          className="relative w-[140px] sm:w-[180px] h-[140px] sm:h-[180px] rounded-full overflow-hidden shadow-lg border-4 border-none"
          style={{
            backgroundColor: "#014458",
      ...
      {/* Ellipse */}
      <div className="absolute top-[215px] sm:top-[215px] left-[45%] sm:left-[57.7%] w-[280px] sm:w-[350px] h-[140px] sm:h-[180px] bg-[#013A4D] rounded-full overflow-hidden">
